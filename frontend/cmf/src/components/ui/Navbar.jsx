...
const Navbar = ({ collapsed }) => {
  ...
  const getTitle = () => {
    ...
    if (path.includes('/notification')) {
      if (path.startsWith('/supervisor')) return 'Inspection plan requests';
      return 'Notification';
    }
    if (path.includes('/create-inspection-plan') && path.startsWith('/supervisor')) {
      return 'Create Inspection Plan';
    }
